...
<template>
  <div class="fixed inset-0 bg-black flex items-center justify-center select-none">
    <div class="w-24 h-24 mb-12 animate-[pulse_2s_infinite]">
      <!-- Apple Logo Placeholder (SVG) -->
      <svg viewBox="0 0 24 24" class="fill-white w-full h-full">
