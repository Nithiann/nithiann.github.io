...
export const portfolioData = {
  personal: {
    ...
    summary: "I am a passionate developer with a strong background in software engineering. Interested in many different technologies and always eager to learn new things. I am a team player and enjoy working in a team. I have a strong work ethic and am always willing to put in the extra effort to get the job done. Security is a top priority for me and I always try to implement the best security practices.",
    education: [
